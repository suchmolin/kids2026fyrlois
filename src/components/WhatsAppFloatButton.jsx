import { whatsappHrefWithText } from '../config/whatsapp.js'

const DEFAULT_FLOAT_MESSAGE =
  'Hola! Quiero más información sobre inglés para niños'

export function WhatsAppFloatButton() {
  const href = whatsappHrefWithText(DEFAULT_FLOAT_MESSAGE)
  ...
  return (
    <a
      ...
      aria-label="Abrir WhatsApp para pedir más información sobre inglés para niños"
    >
      <img
        src="/ws.png"
        alt=""
